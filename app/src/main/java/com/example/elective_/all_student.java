                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        for(DocumentSnapshot documentSnapshot:querySnapshot)
                        {
                            if(documentSnapshot.getData()!=null)
                            {
                                ...
                                String s1;
                                s1=br.get("Student ID")!=null ? br.get("Student ID").toString() : "";
                                id_.setText(s1);
                                ...
                                s1=br.get("Student Name")!=null ? br.get("Student Name").toString() : "";
                                name_.setText(s1);
                                name_.setSingleLine();
                                ...
                                relativeLayout.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        Check_Class.StudentId=id_.getText().toString();
                                        i.putExtra("Year",s1);
                                        startActivity(i);
